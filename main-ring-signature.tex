...
\author[1]{Alonso Gonz\'alez \inst{1}\thanks{This work was funded in part by the French ANR ALAMBIC project 
(ANR-16-CE39-0006).}}
\institute{ENS de Lyon, Laboratoire LIP (U. Lyon, CNRS, ENSL, INRIA, UCBL), France.\\
...
\section{Preliminaries}
    ...
    \section{Our Construction in the PPA setting} \label{sec:hf}
    	...
    	\subsection{The hash functions $h$ and $g$} \label{sec:hf-ppa}
    	
    		\input{our-construction/our-hashes-ppa}
	...
	\section{Our Construction in the SXDH setting} \label{sec:high-level}
        		...
        		\input{intro/high-level-sxdh}
    	
		\subsection{Our Ring Signature}\label{sec:our-construction}
        		\input{our-construction/construction-sxdh} 
		\input{appendix/security-proof-sxdh}
		
		
	\section{Acknowledgments}
		We thank to the anonymous reviewers for the constructive feedback. It was very useful for simplifying the SXDH-based construction.
		We also thanks Carla R\`afols and Mojtaba Khalili for their comments on earlier versions of this work.
...
\vspace{1cm}
	...
	\section{Re-randomizable Groth-Sahai NIZK proofs} \label{sec:GSproofs-hg}
...
%\input{appendix/security-proof}
	...
	\section{The Ring Signatures of Bose et al.~and of Gritti et al.\protect\footnote{Both flaws were communicated to the respective authors.}\protect\footnote{In this section we use multiplicative notation for the group operations to keep the expressions as they appear in the original works.}}\label{sec:rs-flawed}
        	 ...
        	 \section{The Erasures Assumption in Ring Signatures} \label{sec:erasures}
        	 	...
        	 	\input{appendix/erasures}
        	 	
        	 \section{Getting rid of the CRS}
        	 
        	 	\input{appendix/crs-less}
