...
% Author macros::begin %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{An Efficient Ring Signature under Milder Assumptions}
\titlerunning{An Efficient Ring Signature under Milder Assumptions} %optional, in case that the title is too long; the running title should fit into the top page column
