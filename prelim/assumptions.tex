...
We will use the natural translation to asymmetric groups of the permutation pairing assumption introduced by Groth and Lu. We also allow the verifier to interactively ask for the discrete logs of $m-\ell$ elements from the challenge, and we call this assumption $(\ell,m)$-PPA. Hence, the natural translation to asymmetric groups of the pairing product assumptions is the $(m,m)$-PPA (no queries for the adversary and thus non-interactive), which we simply call $m$-PPA.
