Boneh and Boyen introduce a short signature -- each signature consists of only one group element -- which is secure against existential forgery under weak chosen message attacks without random oracles \cite{EC:BonBoy04a}.
...
\begin{definition}[weak Existential Unforgeability (wUF-CMA)] We say that a signature scheme $\Sigma = (\mathsf{KGen},\mathsf{Sign},\mathsf{Ver})$ is wUF-CMA if for any adversary $\advA$
	$$
